...
const QUESTIONS = [
  // Verbal
  { q: "BOOK is to LIBRARY is to:", options: ["Canvas", "Museum", "Artist", "Frame"], answer: 1, domain: "Verbal" },
  ...
  { q: "MELODY is to COMPOSER is to:", options: ["Museum", "Clay", "Sculptor", "Painting"], answer: 2, domain: "Verbal" },
  { q: "Which word means the same?", options: ["Permanent", "Fleeting", "Difficult", "Beautiful"], answer: 1, domain: "Verbal" },
      ...
      {step === 'intro' && (
        <div className="flex flex-col items-center justify-center text-center h-full max-w-2xl mx-auto py-12">
          ...
          <p className="text-lg text-muted-foreground mb-8">
            A comprehensive psychometric evaluation covering four core domains, and Spatial reasoning. 
          </p>
            ...
            <div className="md:col-span-2 bg-card border border-border/50 p-6 rounded-3xl shadow-sm h-[300px]">
              ...
              <ResponsiveContainer width="100%" height="80%">
                <BarChart data={chartData} layout="vertical" margin={{ top: 0, right: 30, left: 0, bottom: 0 }}>
                  ...
                  <Tooltip cursor={{ fill: 'hsl(var(--secondary))' }} formatter={(val) => [`${val} / 5`, 'Score']} />
